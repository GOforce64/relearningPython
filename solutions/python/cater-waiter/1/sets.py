...
def clean_ingredients(dish_name, dish_ingredients):
    ...
    dish = (dish_name, set(dish_ingredients))
    return dish
...
def separate_appetizers(dishes, appetizers):
    ...
    mains = (set(dishes).symmetric_difference(set(appetizers))) & set(dishes)
    return list(mains)
...
def singleton_ingredients(dishes, intersection):
    ...
    singletons = set()
    for dish in dishes:
        singletons = singletons | dish.symmetric_difference(intersection) & dish
    return singletons
